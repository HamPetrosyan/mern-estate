...
export const ListingItem = ({ listing }) => {
  return (
    <div className="text-green-950 shadow shadow-customNormGreen hover:shadow-md hover:shadow-customNormGreen transition-shadow overflow-hidden rounded-lg w-full sm:w-[300px]">
